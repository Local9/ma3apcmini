...
udpPort.on("message", function (oscMsg, timeTag, info) {
  ...
  */
    light_executor(0, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key102") {
    light_executor(1, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key103") {
    light_executor(2, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key104") {
    light_executor(3, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key105") {
    light_executor(4, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key106") {
    light_executor(5, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key107") {
    light_executor(6, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key108") {
    light_executor(7, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key201") {
    light_executor(8, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key202") {
    light_executor(9, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key203") {
    light_executor(10, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key204") {
    light_executor(11, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key205") {
    light_executor(12, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key206") {
    light_executor(13, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key207") {
    light_executor(14, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key208") {
    light_executor(15, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key116") {
    light_executor(24, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key117") {
    light_executor(25, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key118") {
    light_executor(26, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key119") {
    light_executor(27, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key120") {
    light_executor(28, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key121") {
    light_executor(29, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key122") {
    light_executor(30, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key123") {
    light_executor(31, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key131") {
    light_executor(32, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key132") {
    light_executor(33, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key133") {
    light_executor(34, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key134") {
    light_executor(35, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key135") {
    light_executor(36, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key136") {
    light_executor(37, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key137") {
    light_executor(38, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key138") {
    light_executor(39, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key146") {
    light_executor(40, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key147") {
    light_executor(41, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key148") {
    light_executor(42, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key149") {
    light_executor(43, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key150") {
    light_executor(44, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key151") {
    light_executor(45, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key152") {
    light_executor(46, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key153") {
    light_executor(47, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key161") {
    light_executor(48, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key162") {
    light_executor(49, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key163") {
    light_executor(50, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key164") {
    light_executor(51, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key165") {
    light_executor(52, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key166") {
    light_executor(53, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key167") {
    light_executor(54, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key168") {
    light_executor(55, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key176") {
    light_executor(56, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key177") {
    light_executor(57, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key178") {
    light_executor(58, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key179") {
    light_executor(59, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key180") {
    light_executor(60, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key181") {
    light_executor(61, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key182") {
    light_executor(62, oscMsg.args[0].value);
  } else if (oscMsg.address == "/Key183") {
    light_executor(63, oscMsg.args[0].value);
  }
});
